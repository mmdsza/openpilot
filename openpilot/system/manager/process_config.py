...
# In the MetaDrive sim on CI, modeld runs on CPU (tinygrad CPU:LLVM) and can crash
# intermittently. Let manager restart it so the sim test stays reliable. Never set on a car.
